...
function formatarDataCompleta(dataString) {
    ...
    console.log("Data recebida:", dataString); // Para debug
    
    // Formato esperado: "Mon, 02 Mar 2026 21:19:16 GMT"
    try {
        const data = new Date(dataString);
        if (!isNaN(data.getTime())) {
            // Usar UTC para manter o horário original do banco
            ...
            const resultado = `${dia}/${mes}/${ano} ${horas}:${minutos}:${segundos}`;
